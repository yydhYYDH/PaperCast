...
export const ENGINE_ROWS: EngineRow[] = [
  ...
  { stage: '文章生成', engine: 'styles · platform × voice', reusedFrom: 'kangw24/paper2content · QuZhan51496/paper2anything', note: '平台体裁（小红书/知乎/B站）× 讲述者人格（作者自述/科技快讯/技术解读…）' },
  ...
  { stage: '发布', engine: 'xiaohongshu-mcp / zhihu-publisher / biliup', reusedFrom: 'xpzouying/xiaohongshu-mcp · zhihu-publisher · biliup', note: '三个渠道均有人工闸门，不自动群发' },
]
